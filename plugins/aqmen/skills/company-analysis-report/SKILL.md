...
4. Build **on top of** `references/company-analysis-report-template.html` — the
   ...
   - **First copy the template to your output path** with a shell command, e.g.
     `cp "references/company-analysis-report-template.html" company-analysis-report.html`.
